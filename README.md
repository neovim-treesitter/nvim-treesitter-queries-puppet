# nvim-treesitter-queries-puppet

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-puppet/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-puppet/actions/workflows/validate.yml)

Neovim tree-sitter queries for **puppet**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-puppet",
...
- [ ] Changes are scoped to `puppet` — do not include files for other languages
